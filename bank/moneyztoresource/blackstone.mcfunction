...
execute as @initiator[scores={Moneyz=180..}] run give @s blackstone 64

execute as @initiator[scores={Moneyz=180..}] run tell @s §aYou Exchanged 64 Blackstone for 180 Moneyz!
