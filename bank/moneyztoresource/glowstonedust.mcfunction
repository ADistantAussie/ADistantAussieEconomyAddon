...
execute as @initiator[scores={Moneyz=180..}] run give @s glowstone_dust 64

execute as @initiator[scores={Moneyz=180..}] run tell @s §aYou Exchanged 64 Glowstone_dust for 180 Moneyz!
