...
execute as @initiator[scores={Moneyz=180..}] run give @s gunpowder 64

execute as @initiator[scores={Moneyz=180..}] run tell @s §aYou Exchanged 64 Gunpowder for 180 Moneyz!
