...
execute as @initiator[scores={Moneyz=150..}] run give @s polished_diorite 64

execute as @initiator[scores={Moneyz=150..}] run tell @s §aYou Exchanged 64 Polished_diorite for 150 Moneyz!
