...
execute as @initiator[scores={Moneyz=150..}] run give @s red_sandstone 64

execute as @initiator[scores={Moneyz=150..}] run tell @s §aYou Exchanged 64 Red_sandstone for 150 Moneyz!
