...
execute as @initiator[scores={Moneyz=200..}] run give @s polished_basalt 64

execute as @initiator[scores={Moneyz=200..}] run tell @s §aYou Exchanged 64 Polished_basalt for 200 Moneyz!
