...
execute as @initiator[scores={Moneyz=120..}] run give @s andesite 64

execute as @initiator[scores={Moneyz=120..}] run tell @s §aYou Exchanged 64 Andesite for 120 Moneyz!
