...
execute as @initiator[scores={Moneyz=150..}] run give @s polished_granite 64

execute as @initiator[scores={Moneyz=150..}] run tell @s §aYou Exchanged 64 Polished_granite for 150 Moneyz!
