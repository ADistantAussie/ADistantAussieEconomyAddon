...
execute as @initiator[scores={Moneyz=120..}] run give @s diorite 64

execute as @initiator[scores={Moneyz=120..}] run tell @s §aYou Exchanged 64 Diorite for 120 Moneyz!
