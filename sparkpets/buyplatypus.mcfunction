...
execute as @initiator[scores={Moneyz=700..}] run give @s spark_pets_pro:platypus_spawn_egg 1

execute as @initiator[scores={Moneyz=700..}] run tell @s §aYou Exchanged 1 platypus spawn egg for 700 Moneyz!
