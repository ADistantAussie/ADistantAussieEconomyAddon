...
execute as @initiator[scores={Moneyz=500..}] run give @s spark_pets_pro:mouse_spawn_egg 1

execute as @initiator[scores={Moneyz=500..}] run tell @s §aYou Exchanged 1 mouse spawn egg for 500 Moneyz!
