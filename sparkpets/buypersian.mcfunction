...
execute as @initiator[scores={Moneyz=600..}] run give @s spark_pets_pro:persian_spawn_egg 1

execute as @initiator[scores={Moneyz=600..}] run tell @s §aYou Exchanged 1 persian spawn egg for 600 Moneyz!
